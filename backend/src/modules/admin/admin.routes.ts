...
interface BulkAssignmentBody extends AssignmentBody {
  applicationIds?: unknown;
}

interface ReviewSettingsBody {
  dueDate?: string;
}

interface ApplicationSourceSettingsBody {
...
adminRouter.put('/settings/review', async (req, res, next) => {
  const body = req.body as ReviewSettingsBody;
...
adminRouter.put('/settings/application-source', async (req, res, next) => {
  const body = req.body as ApplicationSourceSettingsBody;
...
adminRouter.post('/assignments/bulk', async (req, res, next) => {
  const body = req.body as BulkAssignmentBody;
